    ...
    <div className="landing-container">
      ...
      <div className="card mx-auto">
        <div className="card-body">
          <h1>Ilierette</h1>
          <div className="description mb-4">Dancing nerd | Stage girl <br/> Digital artist</div>
          ...
          <div className="socials">
            <a target="/blank" href="https://www.twitch.tv/ilieret" className="btn btn-primary social-button">
              <div><img src={require('../images/icons/twitch.svg')} className="btn-icon mr-2" /></div>
          ...
          <div className="socials">
            ...
            <a target="/blank" href="https://www.instagram.com/ilierette.art/" className="btn btn-primary social-button">
              <div className="mr-2"><img src={require('../images/icons/instagram.svg')} className="btn-icon" /></div>
              <div> ART </div>
            </a>
          ...
          <div className="socials">
            ...
            <Link to='/blog/' className="btn btn-primary"><img src={require('../images/icons/wordpress.svg')} className="btn-icon" /> Visit blog </Link>
